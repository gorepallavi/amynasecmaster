  ...
  <nav className="breadcrumbs">
    <div className="container">
      <ol>
        ...
        <li className="current">IoT Security Assessment</li>
      </ol>
    </div>
  </nav>
</div>
...
<section id="service-details" className="service-details section">
  ...
  <div className="container">
    ...
    <div className="row gy-5">
      ...
      <div className="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="service-box">
          ...
          <div className="services-list">
            ...
            <a href="#/"className="active"><i className="bi bi-arrow-right-circle"></i><span>IOT Security Assessment</span></a>
      ...
      <h1>IoT Security Assessment</h1>
        <img src="https://via.placeholder.com/800x400" alt="" className="img-fluid services-img"/>

        <p>
            An IoT Security Assessment involves a thorough evaluation of the security measures and vulnerabilities within an Internet of Things (IoT) ecosystem. As IoT devices become increasingly integrated into various sectors such as healthcare, manufacturing, smart homes, and more, ensuring their security is crucial to prevent potential cyber threats and breaches.
        </p>
        <p>
            The assessment not only focuses on technical aspects like device firmware integrity and encryption protocols but also addresses regulatory compliance and privacy concerns associated with data collection and storage.
        </p>
        <p>
            By providing actionable insights and recommendations, an IoT Security Assessment enables organizations to strengthen their defense mechanisms, proactively manage risks, and enhance overall cybersecurity posture. 
        </p>
        <h4>
