  ...
  <nav className="breadcrumbs">
    <div className="container">
      <ol>
        ...
        <li className="current">Red Teaming Assessment</li>
      </ol>
    </div>
  </nav>
</div> 
...
<section id="service-details" className="service-details section">
  ...
  <div className="container">
    ...
    <div className="row gy-5">
      ...
      <div className="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="service-box">
          ...
          <div className="services-list">
            ...
            <a href="#/" className="active"><i className="bi bi-arrow-right-circle"></i><span>Red Teaming Assessment </span></a>
      ...
      <h1>Red Teaming Assessment</h1>
        <img src="https://via.placeholder.com/800x400" alt="" className="img-fluid services-img"/>

        <p>
        
        A Red Teaming Assessment is a comprehensive and realistic simulation of an attack on an organization's security systems and processes. The objective is to evaluate and improve the organization's cybersecurity defenses by mimicking the tactics, techniques, and procedures (TTPs) that real-world attackers might use.
        </p>
        <p>
        Red teaming assessments are conducted within a set framework of rules and guidelines to ensure safety and legality. The RoE defines the extent of the assessment, the types of attacks allowed, and any restrictions to prevent damage or legal issues.
        </p>
        <p>
        Red teaming is often part of a broader security strategy, with regular assessments conducted to continuously test and improve the organization's defenses.
        </p>
        <h4>
