  ...
  <nav className="breadcrumbs">
    <div className="container">
      <ol>
        ...
        <li className="current">Web Application Security Testing</li>
      </ol>
    </div>
  </nav>
</div> 
  ...
  <div className="container">
    ...
    <div className="row gy-5">
      ...
      <div className="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="service-box">
          ...
          <div className="services-list">
            ...
            <a href="#/"className="active" ><i className="bi bi-arrow-right-circle"></i><span>Web Application Security Testing</span></a>
      ...
      <h1>Web Application Security Testing</h1>
        ...
        <p>
            According to the OWASP Top 10 list, web application security testing uncovers issues related to programming, file access, configuration, and more. Addressing these vulnerabilities is crucial to prevent potential impacts on an organization.
        </p>
        <p>
            Regular assessments protect applications from unauthorized access, safeguarding the organization's reputation and resources.
        </p>
        <h4>
