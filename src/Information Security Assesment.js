  ...
  <nav className="breadcrumbs">
    <div className="container">
      <ol>
        ...
        <li className="current">Information Security Assessment</li>
      </ol>
    </div>
  </nav>
</div>
...
<section id="service-details" className="service-details section">
  ...
  <div className="container">
    ...
    <div className="row gy-5">
      ...
      <div className="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="service-box">
          ...
          <div className="services-list">
            ...
            <a href="#/"className="active"><i className="bi bi-arrow-right-circle"></i><span>Information Security Assessment</span></a>
            <a href="#/" ><i className="bi bi-arrow-right-circle"></i><span>Web Application Security Testing</span></a>
            <a href="#/" ><i className="bi bi-arrow-right-circle"></i><span>Mobile Application Security Testing </span></a>
      ...
      <h1>Information Security Assessment</h1>
        <img src="https://via.placeholder.com/800x400" alt="" className="img-fluid services-img"/>

        <p>
        
            Information Security Assessment is a vital process that systematically evaluates an organization's information systems, networks, and infrastructure to uncover vulnerabilities, assess risks, and recommend measures to safeguard sensitive data.
        </p>
        <p>This assessment aims to ensure the confidentiality, integrity, and availability of information assets against a range of potential threats. By utilizing tools such as vulnerability scanners, penetration testing, and security audits, security professionals can identify weaknesses in software, configurations, or operational practices that could be exploited by malicious actors. 
        </p>
        <p>
           Ultimately, an effective information security assessment provides organizations with a clear understanding of their current security posture, enabling them to implement proactive measures to mitigate risks and enhance overall resilience against cyber threats.
        </p>
        <h4>
